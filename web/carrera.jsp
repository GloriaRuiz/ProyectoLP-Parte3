        ...
        <%        
                ...
                while (rs.next()) {    
                    ...
                    <tr>
                        ...
                        <td><a href="carrera.jsp?f_accion=E&f_idcarrera=<%out.print(ide);%>"><img src="borrar.jpeg" width="30" height="30" alt="borrar"/>
                            </a></td>
                            <td><a href="carrera.jsp?f_accion=M1&f_idcarrera=<%out.print(ide);%>"><img src="Lapiz.jpeg" width="30" height="30" alt="Lapiz"/>
                                </a></td>
